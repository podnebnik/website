// code/ali-je-vroce/charts/SeasonalHistogramRobust.tsx
/**
 * Robust version of SeasonalHistogram using improved data processing
 * Fixes inconsistent TODAY label display issue by using better data handling
 */
...
/**
 * Robust SeasonalHistogram with improved TODAY label handling
 */
const SeasonalHistogramRobust = (props: SeasonalHistogramProps) => {
  ...
  // Memoized histogram-specific processing with enhanced TODAY label handling
  const chartOptions = createMemo<Highcharts.Options | null>(() => {
    ...
    console.log(
      "🔥 Histogram Robust chartOptions - processing data, rawData length:",
      rawData.length
    );
    ...
    console.log(
      "🔥 Histogram Robust chartOptions - validated todayTemp:",
      todayTemp
    );
    ...
    try {
      ...
      console.log(
        "🔥 Histogram Robust - using createHistogramChartConfig with todayVal:",
        todayVal
      );
      ...
      console.log("🔥 Histogram Robust - config created successfully");
      return config;
    } catch (e) {
      console.error("🔥 Histogram Robust - Error processing data:", e);
      return null;
    }
  });
...
export default SeasonalHistogramRobust;

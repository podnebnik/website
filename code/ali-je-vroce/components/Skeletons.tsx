        ...
        case "context":
            return (
                <div
                    ...
                    role="contentinfo"
                >
                    <Skeleton as="p" height={24} width={300} class={cn(classNameSkeletonColor, classNameDefaultAnimate)} visible={true} animate radius={10} aria-hidden="true" />
                    <Skeleton as="p" height={24} width={320} class={cn(classNameSkeletonColor, classNameDefaultAnimate, "mt-1")} visible={true} animate radius={10} aria-hidden="true" />
                </div>
            );
        case "lastUpdated":
            return (
